...
public class TestAnalysisResultReader {
	...
	public void setUp() throws Exception {
		...
		dir = TestAnalysisResultReader.class.getClassLoader()
				.getResource("test-output").getPath();
	...
	public void testReader() throws Exception {
		...
		for (int id : projectIDs) {
			try {
				ProjectMetadata metadata = crawler
						.retrieveProjectMetadata(new ProjectMetadata(id));
